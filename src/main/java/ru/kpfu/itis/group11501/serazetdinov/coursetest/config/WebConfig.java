...
@Configuration
@EnableWebMvc
@ComponentScan("ru.kpfu.itis.group11501.serazetdinov.coursetest")
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/font-awesome/**")
                .addResourceLocations("/resources/static/font-awesome/")
                .setCachePeriod(86400);
        registry.addResourceHandler("/sounds/**")
                .addResourceLocations("/resources/static/sounds/")
                .setCachePeriod(86400);
        registry.addResourceHandler("/references/**")
                .addResourceLocations("/loadFiles/references/")
                .setCachePeriod(86400);
    }
