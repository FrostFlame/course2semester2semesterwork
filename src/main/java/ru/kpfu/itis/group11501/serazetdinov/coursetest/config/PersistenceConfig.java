...
@EnableJpaRepositories("ru.kpfu.itis.group11501.serazetdinov.coursetest.repository")
...
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() throws PropertyVetoException, IOException {
        ...
        entityManagerFactory.setPackagesToScan("ru.kpfu.itis.group11501.serazetdinov.coursetest.model");
